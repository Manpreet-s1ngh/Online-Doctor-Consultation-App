...
public class Doctor_Forget_Password extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor__forget__password);
...
//
                          ...
                          StringRequest request= new StringRequest(StringRequest.Method.GET, url, new Response.Listener<String>() {
                              ...
                              public void onResponse(String response) {
                                  ...
                                  Toast.makeText(Doctor_Forget_Password.this, "Message Sent to Your Registered Mobile number.", Toast.LENGTH_SHORT).show();
                                 finish();
                              }
                          ...
                          Volley.newRequestQueue(Doctor_Forget_Password.this).add(request);

                      }
                  }
                  else {
                      Toast.makeText(Doctor_Forget_Password.this, "No record found", Toast.LENGTH_SHORT).show();
                  }
              }
